...
<Note>
  Please note that this is a newer version and uses the `.SelectMenu` classes instead of the <a href="/css/components/select-menu-deprecated">deprecated select menu</a> `.select-menu` classes. Check the <a href="/css/components/select-menu-deprecated">migration guide</a> to make sure your app is up to date.
</Note>
