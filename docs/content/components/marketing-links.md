...
<a href="#" class="link-mktg text-semibold f3-mktg">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" class="octicon link-arrow-mktg" width="16" height="16" viewBox="0 0 16 16" fill="none">
...
```html live
<a href="#" class="link-mktg text-semibold f3-mktg color-fg-default mr-4">
    Call to action
