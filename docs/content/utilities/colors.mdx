...
<div class="border color-border-accent-muted p-2 rounded mb-2">.color-border-accent-muted</div>

<div class="border color-border-success-emphasis p-2 rounded mb-2">.color-border-success-emphasis</div>
<div class="border color-border-success-muted p-2 rounded mb-2">.color-border-success-muted</div>

<div class="border color-border-attention-emphasis p-2 rounded mb-2">.color-border-attention-emphasis</div>
<div class="border color-border-attention-muted p-2 rounded mb-2">.color-border-attention-muted</div>

<div class="border color-border-severe-emphasis p-2 rounded mb-2">.color-border-severe-emphasis</div>
<div class="border color-border-severe-muted p-2 rounded mb-2">.color-border-severe-muted</div>

<div class="border color-border-danger-emphasis p-2 rounded mb-2">.color-border-danger-emphasis</div>
<div class="border color-border-danger-muted p-2 rounded mb-2">.color-border-danger-muted</div>

<div class="border color-border-done-emphasis p-2 rounded mb-2">.color-border-done-emphasis</div>
<div class="border color-border-done-muted p-2 rounded mb-2">.color-border-done-muted</div>
