...
Use color utilities to apply color to the background of elements, text, and borders. These utilities should be used for specific color usage that is not provided by a component. To learn more about how color is used and how to appropriately apply it to your project, read the [color documentation](https://primer.style/design/foundations/color) in the [interface guidelines](https://primer.style/design/).
