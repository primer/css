...
```html live
<div class="border border-primary mb-2">.border-primary</div>
<div class="border border-secondary mb-2">.border-secondary</div>
<div class="border border-tertiary mb-2">.border-tertiary</div>
<div class="border border-info mb-2">.border-info</div>
<div class="border border-success mb-2">.border-success</div>
<div class="border border-warning mb-2">.border-warning</div>
<div class="border border-danger mb-2">.border-danger</div>

<div class="bg-canvas-inverse text-inverse p-3">
...
```html live
<div class="border border-black-fade bg-info p-2 mb-2">.border-black-fade</div>
<div class="border border-black-fade bg-danger p-2 mb-2">.border-black-fade</div>
```
...
```html live
<div class="bg-info-inverse text-inverse p-3">
