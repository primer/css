---
title: Primer v18 migration guide
description: 'Guide for migrating to version 18.0.0 of Primer'
---

Primer v18.0.0 replaces color modes V1 with V2. To help with the migration, please refer to the guide below.

<Note>
  The functional CSS color variables changed as well. Plese refer to [deprecated variables section](https://primer.style/primitives/colors#deprecated-variables).
</Note>
