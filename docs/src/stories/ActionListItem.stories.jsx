...
export const SizeMedium = args => (
  <>
    <ul className="actionList actionList--sizeMedium">
      <li className="actionList-item actionList-item--sizeMedium">
        <span className="actionList-item-content">Medium item size</span>
      </li>
    </ul>
  </>
)
...
export const SizeLarge = args => (
  <>
    <ul className="actionList actionList--sizeLarge">
      <li className="actionList-item actionList-item--sizeLarge">
        <span className="actionList-item-content">Large item size</span>
      </li>
    </ul>
  </>
)
...
export const SectionDividerFilled = args => (
  <>
    <h4 className="actionList-sectionHeader actionList-sectionHeader--filled">Section title</h4>
  </>
)
...
export const LeadingVisual = args => (
  <>
    ...
    <li className="actionList-item">
      <div className="actionList-item-content">
        <span className="actionList-item-leadingVisual-16">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
            <path
              fill-rule="evenodd"
              d="M1.5 8a6.5 6.5 0 1113 0 6.5 6.5 0 01-13 0zM8 0a8 8 0 100 16A8 8 0 008 0zm.75 4.75a.75.75 0 00-1.5 0v2.5h-2.5a.75.75 0 000 1.5h2.5v2.5a.75.75 0 001.5 0v-2.5h2.5a.75.75 0 000-1.5h-2.5v-2.5z"
        ...
        <span className="actionList-item-label">Item with leading visual 16px width</span>
      </div>
    </li>
    <li className="actionList-item">
      <div className="actionList-item-content">
        <span className="actionList-item-leadingVisual-20">
        ...
        <span className="actionList-item-label">Item with leading visual 20px width</span>
      </div>
    </li>
  </>
)
  ...
  <>
    <li className="actionList-item">
      <div className="actionList-item-content">
        ...
        <span className="actionList-item-trailingVisual">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
            <path
              fill-rule="evenodd"
              d="M1.5 8a6.5 6.5 0 1113 0 6.5 6.5 0 01-13 0zM8 0a8 8 0 100 16A8 8 0 008 0zm.75 4.75a.75.75 0 00-1.5 0v2.5h-2.5a.75.75 0 000 1.5h2.5v2.5a.75.75 0 001.5 0v-2.5h2.5a.75.75 0 000-1.5h-2.5v-2.5z"
  ...
  <>
    ...
    <li className="actionList-item">
      <div className="actionList-item-content">
        ...
        <span className="actionList-item-label">Item with leading icon + trailing text</span>
        <span className="actionList-item-trailingText">Copy</span>
      </div>
    </li>
  </>
)
