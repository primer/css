...
# Action list tree view variation
...
| `<button>` | `onClick`, `aria-haspopup`, `aria-expanded`, `aria-controls`. `id` |
...
| element | attributes                                                                                                                 |
| ------- | -------------------------------------------------------------------------------------------------------------------------- |
| `<li>`  | `onClick`, `aria-level`, `role="treeitem"`, `aria-haspopup`, `aria-expanded`, `id`                                         |
