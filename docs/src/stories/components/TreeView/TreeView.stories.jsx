import {TreeViewListItemCollapsibleTemplate} from '../../ui-patterns/ActionList/TreeViewListItemCollapsible.stories.jsx'
...
export const TreeViewTemplate = ({showGroupIcon, showSubItemIcon, text, truncateItem}) => (
