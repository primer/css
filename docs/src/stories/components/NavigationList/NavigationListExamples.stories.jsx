...
import {DividerTemplate} from './NavigationListDivider.stories'
import {ListItemTemplate} from './NavigationListItem.stories'
import {ListTemplate} from './NavigationList.stories'
...
export const RepoSettings = ({}) => (
  <nav>
    ...
    <ListTemplate ariaLabelledBy="group-id-1">
      <ListItemTemplate
        text="Collaborators"
        href="#content"
        leadingVisualSize="ActionList-content--visual16"
      ...
      <ListItemCollapsibleTemplate
        ...
        leadingVisualSize="ActionList-content--visual16"
      >
        <ListTemplate subGroup>
          <ListItemTemplate text="Interaction limits" href="#content" subItem />
        </ListTemplate>
      </ListItemCollapsibleTemplate>
    </ListTemplate>
  </nav>
                ...
                <ListItemTemplate
                  ...
                  children={
                    <ListTemplate
                      ...
                      children={
                        <>
                          <ListItemTemplate subItem text="Interaction limits" href="/" ariaCurrent="page" />
                          <ListItemTemplate subItem text="Blocked users" href="/" />
                          <ListItemTemplate subItem text="Code review limits" href="/" />
                          <ListItemTemplate subItem text="Reported content" href="/" />
                        </>
                      }
                    />
                  }
