...
import {ListItemCollapsibleTemplate} from './NavigationListItemCollapsible.stories'
  ...
  <nav>
    ...
    <NavigationListTemplate ariaLabelledBy="group-id-1">
      ...
      <ListItemCollapsibleTemplate
        ...
        leadingVisualSize="ActionList-content--visual16"
      >
        <NavigationListTemplate subGroup>
          <NavigationListItemTemplate text="Interaction limits" href="#content" subItem />
          <NavigationListItemTemplate text="Interaction limits" href="#content" subItem ariaCurrent="page" />
          <NavigationListItemTemplate text="Interaction limits" href="#content" subItem />
        </NavigationListTemplate>
      </ListItemCollapsibleTemplate>
      <NavigationListDividerTemplate />
      <NavigationListDividerTemplate title="Access" id="group-id-2" />
      <NavigationListTemplate ariaLabelledBy="group-id-2">
        <NavigationListItemTemplate text="Interaction limits" href="#content" />
        <NavigationListItemTemplate text="Interaction limits" href="#content" />
        <NavigationListItemTemplate text="Interaction limits" href="#content" />
      </NavigationListTemplate>
    </NavigationListTemplate>
...
export const NavRepoSettings = NavigationListTemplate.bind({})
...
NavRepoSettings.args = {
  ...
  children: (
    <>
                ...
                <NavigationListItemTemplate
                  ...
                  children={
                    <NavigationListTemplate
                      ...
                      children={
                        <>
                          <NavigationListItemTemplate subItem text="Interaction limits" href="/" ariaCurrent="page" />
                          <NavigationListItemTemplate subItem text="Blocked users" href="/" />
                          <NavigationListItemTemplate subItem text="Code review limits" href="/" />
                          <NavigationListItemTemplate subItem text="Reported content" href="/" />
                        </>
                      }
                    />
                  }
      ...
      />
      <NavigationListDividerTemplate />
      <NavigationListDividerTemplate title="Security" id="group-id-3" />
      <NavigationListItemTemplate
        containsSubItem
        children={
          <NavigationListTemplate
