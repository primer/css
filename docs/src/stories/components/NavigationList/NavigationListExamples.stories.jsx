    ...
    <NavigationListTemplate ariaLabelledBy="group-id-1">
      ...
      >
        <NavigationListTemplate listType="nested">
          <NavigationListItemTemplate text="Interaction limits" href="#" subItem />
          <NavigationListItemTemplate text="Code review limits" href="#" subItem ariaCurrent="page" />
          <NavigationListItemTemplate text="Reported content" href="#" subItem />
        </NavigationListTemplate>
      </NavigationListItemCollapsibleTemplate>
      <NavigationListDividerTemplate />
