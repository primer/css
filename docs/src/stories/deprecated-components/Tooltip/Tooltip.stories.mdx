...
<Meta title="Deprecated/Tooltip/Docs" />
...
<Canvas>
  <Story story={TooltipStories.Default} />
</Canvas>
...
<Canvas>
  <Story story={TooltipStories.Alignment} />
</Canvas>
...
<Canvas>
  <Story story={TooltipStories.MultiLine} />
</Canvas>
...
<Canvas>
  <Story story={TooltipStories.NoDelay} />
</Canvas>
