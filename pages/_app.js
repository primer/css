...
import {Header, MarkdownHeading, JumpNav, SideNav, withAnalytics} from '@primer/blueprints'
...
export default withAnalytics(
  class MyApp extends App {
    ...
    render() {
      ...
      const node = pageTree.first(node => node.path === pathname) || {}
      ...
      return (
        <BaseStyles fontSize={2} style={{fontFamily: theme.fonts.normal}}>
          <Container>
            ...
            <Header documents={documents} root="https://primer.style" subfolder="css" title="Primer" subtitle="CSS">
              <JumpNav />
            </Header>
            <Flex
